...
date=" updated at "+data_analytic.tail(1).index.values[0]
...
def results_covid(case,case_max,icu,icu_max,vacc):
    ...
    if (cases_7days_mean-case_max>0):
        ...
        output=output+pstart+"The Average 7 day case is : "+str(int(cases_7days_mean))+        "<br> Our target is  : " +str(int(case_max))+        "<br> We need to lessen average positive case by : " +str(int(case-case_max))+pend
